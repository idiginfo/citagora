...
CREATE TABLE CITAGORA_REFERENCES (MYID INTEGER NOT NULL, ABSTRACTTEXT VARCHAR(255), ACCURACYRATING DOUBLE, AUTHORSTRING VARCHAR(255), BIBOTYPE VARCHAR(255), DOI VARCHAR(255) UNIQUE, ISSUED DATETIME, LANGUAGE VARCHAR(255), ORIGINALITYRATING DOUBLE, OVERALLRATING DOUBLE, PAGEEND INTEGER, PAGESTART INTEGER, PAGES VARCHAR(255), PMID VARCHAR(255) UNIQUE, PUBLISHER VARCHAR(255), READABILITYRATING DOUBLE, SEEALSO LONGBLOB, SHORTTITLE VARCHAR(255), SUBJECT VARCHAR(255), TITLE VARCHAR(255), VOLUME VARCHAR(255), CONTRIBUTEDBY_MYID INTEGER, isPartOf INTEGER, PRIMARY KEY (MYID))
