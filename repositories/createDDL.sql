CREATE TABLE citagora_objects (MYID INTEGER NOT NULL, DTYPE VARCHAR(31), CREATED DATETIME, GENERATED DATETIME, RIGHTS VARCHAR(255), SOURCE VARCHAR(255), TYPE VARCHAR(255), UPDATED DATETIME, URI VARCHAR(255) UNIQUE, WASATTRIBUTEDTO VARCHAR(255), GENERATOR_MYID INTEGER, PRIMARY KEY (MYID))
CREATE TABLE CITAGORA_REFERENCES (MYID INTEGER NOT NULL, ABSTRACTTEXT VARCHAR(10000), ACCURACYRATING DOUBLE, AUTHORSTRING VARCHAR(1000), BIBOTYPE VARCHAR(255), DOI VARCHAR(255) UNIQUE, ISBN VARCHAR(255) UNIQUE, ISSN VARCHAR(255) UNIQUE, ISSUE VARCHAR(255), ISSUED DATETIME, LANGUAGE VARCHAR(255), ORIGINALITYRATING DOUBLE, OVERALLRATING DOUBLE, PAGEEND INTEGER, PAGESTART INTEGER, PAGES VARCHAR(255), PMID VARCHAR(255) UNIQUE, PUBLISHER VARCHAR(255), READABILITYRATING DOUBLE, SEEALSO LONGBLOB, SHORTTITLE VARCHAR(255), SUBJECT VARCHAR(1000), TITLE VARCHAR(1000), URL VARCHAR(255), VOLUME VARCHAR(255), CONTRIBUTEDBY_MYID INTEGER, isPartOf INTEGER, PRIMARY KEY (MYID))
