CREATE TABLE citagora_objects (MYID INTEGER NOT NULL, DTYPE VARCHAR(31), CREATED DATETIME, GENERATED DATETIME, RIGHTS VARCHAR(1000), SOURCE VARCHAR(255), SOURCEID VARCHAR(255), TYPE VARCHAR(255), UPDATED DATETIME, URI VARCHAR(255) UNIQUE, WASATTRIBUTEDTO VARCHAR(255), GENERATOR_MYID INTEGER, PRIMARY KEY (MYID))
CREATE TABLE annotations (MYID INTEGER NOT NULL, CONTEXT VARCHAR(2000), MODELVERSION VARCHAR(255), SPECIFIER VARCHAR(255), TAGS VARCHAR(255), CHARACTERENCODING VARCHAR(255), CHARS VARCHAR(2000), X INTEGER, ANNOTATOR_MYID INTEGER, PRIMARY KEY (MYID))
