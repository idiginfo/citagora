...
CREATE TABLE citagora.annotations (MYID INTEGER NOT NULL, CONTEXT VARCHAR(2000), MODELVERSION VARCHAR(255), SPECIFIER VARCHAR(255), TAGS VARCHAR(255), CHARACTERENCODING VARCHAR(255), CHARS VARCHAR(255), ANNOTATOR_MYID INTEGER, PRIMARY KEY (MYID))
