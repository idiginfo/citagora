...
ALTER TABLE citagora_references ADD CONSTRAINT UNQ_citagora_references_0 UNIQUE (ref_source, doi)
ALTER TABLE citagora_references ADD CONSTRAINT UNQ_citagora_references_1 UNIQUE (ref_source, pmid)
