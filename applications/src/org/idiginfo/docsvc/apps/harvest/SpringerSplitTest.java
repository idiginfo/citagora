...
public class SpringerSplitTest {
...
//	private static final int MAX_FILES = 300;
	...
	private void run(String[] args) {
		...
		numFiles = apiSplit.splitFiles(ParameterConstants.Springer.IN_FILE_PREFIX, ParameterConstants.Springer.SPLIT_FILE_PREFIX);
		System.out.println("Number of files processed: " + numFiles);
	}
	
	public static void main(String[] args) {
		SpringerSplitTest splitter = new SpringerSplitTest();
		splitter.run(args);
		return;
	}
