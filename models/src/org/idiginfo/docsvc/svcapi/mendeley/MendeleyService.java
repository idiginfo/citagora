...
public class MendeleyService {
    ...
    public MendeleyRecord getMendeleyRecord(String function, String uuid, ApiParams params) {
    ...
    public List<MendeleyHeader> getMendeleyHeaders(String function, String search, ApiParams params) {
    ...
    public MendeleyResult getMendeleyResult(String function, String search, ApiParams params) {
	JsonElement content = queryService(function, search, params);
	MendeleyResult result = gson.fromJson(content, MendeleyResult.class);
	return result;
    }

    public String getMendeleyUUID(String function, String search, ApiParams params) {
	JsonElement content = queryService(function, search, params);
	String contentString = gson.toJson(content);
	return contentString;
    }

    private JsonElement queryService(String function, String search, ApiParams params) {
	try {
