...
public class AuthenticationClient {
	public static String REMOTE_WSDL_URL =  "http://search.webofknowledge.com/esti/wokmws/ws/WOKMWSAuthenticate?wsdl";
	public static URL LOCAL_WSDL_URL = WOKMWSAuthenticateService.WSDL_LOCATION;
	private static QName SERVICE_NAME = WOKMWSAuthenticateService.SERVICE;
